/*==============================================================================
DO FILE NAME:			08c_an_model_checks
...
DESCRIPTION OF FILE:	program 08a
						...
						Objective 1: comparing OAC treated and general population
...
stcox i.exposure i.male age1 age2 age3 $dagvarlist i.ethnicity , strata(set_id)
estat phtest, detail
...
stcox i.exposure i.male age1 age2 age3 $fullvarlist i.ethnicity, strata(set_id)
estat phtest, detail
