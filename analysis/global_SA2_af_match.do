...
di "$outdir"
global tempdir_main_analysis "$projectdir/output/oac_match_tempdata" 
di "$tempdir_main_analysis"
global logdir "$projectdir/output/oac_match_log/sens_analysis_2"
di "$logdir"
global tempdir "$projectdir/output/oac_match_tempdata/sens_analysis_2" 
di "$tempdir"
global tabfigdir "$projectdir/output/oac_match_tabfig/sens_analysis_2" 
di "$tabfigdir"

adopath + "$projectdir/analysis/extra_ados"

* Create directories required 
capture mkdir "$outdir/oac_match_tabfig/sens_analysis_2"
capture mkdir "$outdir/oac_match_log/sens_analysis_2"
capture mkdir "$outdir/oac_match_tempdata/sens_analysis_2"
