...
global logdir "$projectdir/output/oac_log/sens_analysis_1"
di "$logdir"
global tempdir "$projectdir/output/oac_tempdata/sens_analysis_1" 
di "$tempdir"
global tabfigdir "$projectdir/output/oac_tabfig/sens_analysis_1" 
di "$tabfigdir"

adopath + "$projectdir/analysis/extra_ados"

* Create directories required 
capture mkdir "$outdir/oac_tabfig/sens_analysis_1"
capture mkdir "$outdir/oac_log/sens_analysis_1"
capture mkdir "$outdir/oac_tempdata/sens_analysis_1"
