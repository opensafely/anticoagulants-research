/*==============================================================================
DO FILE NAME:			06c_an_models_ethnicity
PROJECT:				Anticoagulant in COVID-19 
DATE: 					6 Nov 2020 
AUTHOR:					A Wong 		
DESCRIPTION OF FILE:	program 6c, restrict to known ethnicity (complete case analysis)
...
cap log close
log using $logdir\06c_an_models_ethnicity_`outcome', replace t
