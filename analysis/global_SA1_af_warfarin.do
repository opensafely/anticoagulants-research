...
global logdir "$projectdir/output/warfarin_log/sens_analysis_1"
di "$logdir"
global tempdir "$projectdir/output/warfarin_tempdata/sens_analysis_1" 
di "$tempdir"
global tabfigdir "$projectdir/output/warfarin_tabfig/sens_analysis_1" 
di "$tabfigdir"

adopath + "$projectdir/analysis/extra_ados"

* Create directories required 
capture mkdir "$outdir/warfarin_tabfig/sens_analysis_1"
capture mkdir "$outdir/warfarin_log/sens_analysis_1"
capture mkdir "$outdir/warfarin_tempdata/sens_analysis_1"
